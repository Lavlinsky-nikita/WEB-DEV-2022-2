...
# join - Обединяет элементы(для коректного отображения в нашем случае)
# keys - возвращает ключ
choice = ", ".join(london_co[device].keys())
# f строка для форматирования, берут значения переменных доступных в видимости и подставляют в строку, { } - указываем имя переменной 
